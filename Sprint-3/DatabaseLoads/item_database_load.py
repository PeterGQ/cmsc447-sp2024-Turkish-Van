...
item_list = [
    ...
    ("Longsword Upgrade: Balanced Hilt", "An upgrade that permanently increases the player’s attack by 15% when equipped", "SH_EQ", r"Icons\Longsword Upgrade Balanced Hilt.png", 0, None, 1.15, None, 100, 0, 75),
    ("Longsword Upgrade: Sharpened Blade", "An upgrade that increases the player’s attack by 30%", "SH_EQ", r"Icons\Longsword Upgrade Sharpened Blade.png", 0, None, 1.30, None, 100, 0, 150),
    ("Leather Armlet", "A basic accessory that reduces incoming damage by 10% when equipped.", "SH_EQ", r"Icons\Leather Armlet.png", 0, None, None, 1.10, 100, 0, 50),
    ("Guardian’s Breastplate", "An upgraded accessory that reduces incoming damage by 25%", "SH_EQ", r"Icons\Guardian’s Breastplate.png", 0, None, None, 1.25, 100, 0, 100),
